...
[![npm version](https://badge.fury.io/js/count-up.svg)](https://www.npmjs.com/package/count-up)
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](LICENSE)

## Installation

```bash
npm install count-up
```

## Quick Start

```javascript
const { up } = require('count-up');
...
```javascript
const { up, batch } = require('count-up');
